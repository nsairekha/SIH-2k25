...
exports.reportCrisis = exports.updateSafetyPlan = exports.createSafetyPlan = exports.getSafetyPlan = exports.getCopingStrategies = exports.getCrisisResourcesByCountry = exports.getCrisisResources = void 0;
...
const getCrisisResourcesByCountry = async (req, res) => {
    try {
        const { country } = req.params;
        const resources = crisisResources[country] || [];
        res.json({
            success: true,
            data: { resources }
        });
...
exports.getCrisisResourcesByCountry = getCrisisResourcesByCountry;
const getCopingStrategies = async (req, res) => {
    try {
        ...
        if (category && strategies[category]) {
            selectedStrategies = strategies[category];
        }
        res.json({
            success: true,
...
exports.getCopingStrategies = getCopingStrategies;
const getSafetyPlan = async (req, res) => {
    try {
...
exports.getSafetyPlan = getSafetyPlan;
...
exports.reportCrisis = reportCrisis;
